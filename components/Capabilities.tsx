...
export default function Capabilities() {
  const capabilities = [
    ...
    },
    {
      ...
      description: "Advanced models to anticipate grid failures and supply chain breaks."
    },
    {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {capabilities.map((cap, idx) => (
            <motion.div
              ...
              className="group relative bg-white/5 p-8 border border-white/5 hover:border-transparent transition-all duration-300 corner-border"
            >
