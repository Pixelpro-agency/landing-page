            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    <div className="inline-flex items-center text-red-500 font-mono text-xs tracking-widest uppercase mb-6 border border-red-500/30 px-3 py-1 rounded bg-red-500/5">
                        <AlertTriangle className="w-3 h-3 mr-2" /> {t('problem.badge')}
                    </div>
                    <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tighter mb-4">
                        {t('problem.title1')} <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400">{t('problem.title2')}</span>
                    </h2>
                </motion.div>
                ...
                <div className="grid md:grid-cols-3 gap-12 relative">
                    ...
                    >
                        ...
                        <div className="text-center px-4">
                            <h3 className="text-xl font-bold text-white mb-4">{t('problem.siloed.title')}</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                                {t('problem.siloed.desc')}
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="text-center px-4">
                            <h3 className="text-xl font-bold text-white mb-4">{t('problem.blindspots.title')}</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                                {t('problem.blindspots.desc')}
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="text-center px-4">
                            <h3 className="text-xl font-bold text-white mb-4">{t('problem.static.title')}</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                                {t('problem.static.desc')}
                            </p>
                        </div>
                    </motion.div>
