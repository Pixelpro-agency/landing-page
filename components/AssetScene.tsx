...
function CityScene() {
    ...
    return (
        <group ref={groupRef} position={[0, -2.5, 0]}>
            ...
            {/* --- GRID SUBSTATION --- */}
            <group position={[-3.8, 0, 1]} rotation={[0, Math.PI / 2, 0]}>
            ...
            {/* --- INTELLIGENCE LAYER --- */}
            <group>
                <IntelligenceLabel position={[-3.8, 3, 1]} label="GRID: STABLE" type="grid" />
                <DataConnection start={[-3.8, 2, 1]} end={[1, 3, -1]} color="#f59e0b" pulse={true} />
            </group>
