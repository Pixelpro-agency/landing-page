...
Welcome to EstateVision! These Terms of Service (the "Terms") govern your access to and use of the EstateVision mobile and web applications, website, and any related services (collectively, the "Services"). By accessing or using the Services, you agree to be bound by these Terms. If you do not agree, you may not use the Services.

1. Acceptance of Terms
By creating an account, accessing, or using EstateVision, you acknowledge that you have read, understood, and agree to be legally bound by these Terms and our Privacy Policy. If you do not agree with these Terms, you must immediately discontinue your use of the Services.
...
EstateVision provides digital estate planning, property management, and related services (the "Services"). We may modify, update, or discontinue certain features at any time without notice, at our sole discretion.
...
5. Fees and Payment
Subscription Plans: Some features of EstateVision may require payment (e.g., subscription fees). The applicable fees, duration, and payment terms will be provided at the point of purchase.
...
Refunds: All fees are typically non-refundable unless required by law or stated otherwise in writing by EstateVision.
...
No Unauthorized Access: You must not access or attempt to access non-public areas of EstateVision.
7. Intellectual Property
EstateVision and its licensors own all rights, titles, and interests in and to the Services, including all software, text, media, and trademarks used within them.
...
9. Disclaimers
No Legal Advice: EstateVision is not a law firm and does not provide legal advice. Any materials or information provided through the Services are for informational purposes only.
...
To the fullest extent permitted by law, EstateVision shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill.
